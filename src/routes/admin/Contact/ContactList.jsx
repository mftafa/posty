import SingleContact from "../../../components/Contact/SingleCountact.jsx";
import useFetch from "../../../hooks/useFetchData.js";
import Loading from "../../../components/Shared/Loading.jsx";

export default function ContactList(){

    const { data, loading, error } = useFetch('https://66063693d92166b2e3c36964.mockapi.io/api/react-posts/contact');
